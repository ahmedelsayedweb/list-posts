        ...
        <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
                <p class="text-sm text-white">
                    ...
                    to
                    <span class="font-medium">{{ startIndex + itemsPerPage < posts.length ? startIndex + itemsPerPage : posts.length }}</span>
                    of
            ...
            <div>
                <div class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <button @click="nextPage"
                        class="relative inline-flex items-center rounded-r-md px-2 py-2 text-white ring-1 ring-inset ring-gray-300 hover:bg-indigo-600 focus:z-20 focus:outline-offset-0">
